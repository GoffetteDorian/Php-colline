                    ...
                    <div id="profile-box" class="col-md-12">
                        <form id="profile-form" class="form" action="profile.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" name="username_change" id="username_change" class="form-control" value="Change Username"><br>
                                <?php
                            ...
                            <div class="form-group">
                                <input type="submit" name="password_change" id="password_change" class="form-control" value="Change Password"><br>
                                <?php
                            ...
                            <div class='form-group'>
                                ...
                                echo '<input type="text" name="signact" id="signact" class="form-control" value="' . $row['signature'] . '" disabled="disbaled"><br>'
                                ?>
